...
# You Don't Need a Perfect Morning to Begin Clearly {#welcome}

```{=typst}
#mcr-lead[Most mornings begin already full — before you have decided how you want to enter them.]
```

Before your feet are properly on the floor, the day is often already talking.
A list of things to do. A couple of half-formed worries. The money-related
