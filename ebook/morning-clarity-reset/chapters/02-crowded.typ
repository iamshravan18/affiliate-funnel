...
#block(above: 12pt, below: 12pt, mcr-cards(cols: 1, (
  ...
  ("Think about money or responsibilities", "The weightier thoughts start on their own."),
  ("React before setting an intention", "You respond to the noise instead of choosing where to begin."),
)))

None of this means anything is wrong with you. It simply means the morning
started talking before you had a chance to answer. The reset in this guide adds
...
#mcr-panel(title: "A few questions to sit with")[
  ...
  #v(3pt)
  1. What is usually the first thing competing for my attention in the morning?
  2. When do I tend to start reacting before I have decided anything?
  3. What would one quieter minute at the start of the day make room for?
]
#pagebreak(weak: true)
