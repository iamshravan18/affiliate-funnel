...
The whole routine rests on three simple movements. Together they turn a crowded
morning into something you can actually walk through — one small step at a time.
...
These three movements open into #strong[seven short steps], one for each minute:
Arrive, Notice, Name, Separate, Choose, Picture, and Continue. The next pages
walk through them, two or three at a time.
#pagebreak(weak: true)
