...
// ---------------------------------------------------------------------------
// CITATION SUPERSCRIPTS (Phase 3) — numbered source markers should never crowd
// the preceding word/punctuation or wrap onto their own line. We shadow the
// built-in `super` so this applies to BOTH native #super[N] markers and the
// pandoc-generated ^N^ markers, giving a consistent hair of space and keeping
// each marker glued (non-breaking) to the word it follows.
// ---------------------------------------------------------------------------
#let __wcg-super-orig = super
#let super(body) = box(baseline: 0pt)[#h(0.6pt)#__wcg-super-orig(body)]
