...
BOOKMARKS = [
    ...
    [2, "Day 2", 7],
    [2, "Day 3", 9],
    [2, "Explore the Pattern Beneath the Habit", 11],
    [2, "Day 4", 12],
    [2, "Day 5", 14],
    [2, "Day 6", 16],
    [2, "Day 7", 18],
    [2, "Your Recommended Next Step", 20],
    [2, "Seven-Day Reflection", 21],
    [2, "Common Spending Moments", 22],
    [2, "Automatic Spending Audit", 23],
    [2, "Compassionate Restart", 24],
    [2, "Your Next 30 Days", 25],
    [2, "Continue Your Financial Journey", 26],
    [2, "Sources & References", 27],
    [2, "One Last Thing", 28],
]
